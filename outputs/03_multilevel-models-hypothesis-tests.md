...
|                 | (0.067)        |                 | (0.067)        |
+-----------------+----------------+-----------------+----------------+
| z_ksa3_tot      | -0.052         | -0.050          | -0.052         |
+-----------------+----------------+-----------------+----------------+
|                 | (0.066)        | (0.067)         | (0.067)        |
+-----------------+----------------+-----------------+----------------+
| z_kn_total      | 0.336\*\*\*    | 0.337\*\*\*     | 0.333\*\*\*    |
+-----------------+----------------+-----------------+----------------+
|                 | (0.057)        | (0.057)         | (0.058)        |
+-----------------+----------------+-----------------+----------------+
| z_sdr5_tot      | -0.043         | -0.029          | -0.042         |
+-----------------+----------------+-----------------+----------------+
|                 | (0.057)        | (0.058)         | (0.058)        |
+-----------------+----------------+-----------------+----------------+
| z_frlf_rd       |                | -0.047          |                |
...
| class_id)       |                |                 |                |
+-----------------+----------------+-----------------+----------------+
| SD (Intercept   | 0.116          | 0.107           | 0.112          |
| school_id)      |                |                 |                |
+-----------------+----------------+-----------------+----------------+
| SD              | 0.941          | 0.941           | 0.943          |
| (Observations)  |                |                 |                |
+-----------------+----------------+-----------------+----------------+
| Num.Obs.        | 285            | 284             | 285            |
+-----------------+----------------+-----------------+----------------+
| R2 Marg.        | 0.113          | 0.116           | 0.114          |
+-----------------+----------------+-----------------+----------------+
| RMSE            | 0.93           | 0.93            | 0.93           |
+-----------------+----------------+-----------------+----------------+
| -   p \< 0.1,   |                |                 |                |
...
|                          | Base        | Facet        | Int.        |
+==========================+=============+==============+=============+
| (Intercept)              | -0.018      | -0.021       | -0.024      |
+--------------------------+-------------+--------------+-------------+
|                          | (0.075)     | (0.074)      | (0.073)     |
+--------------------------+-------------+--------------+-------------+
| z_frlf_tot               | 0.004       |              | 0.010       |
+--------------------------+-------------+--------------+-------------+
|                          | (0.069)     |              | (0.069)     |
+--------------------------+-------------+--------------+-------------+
| z_ksa3_tot               | 0.062       | 0.066        | 0.064       |
+--------------------------+-------------+--------------+-------------+
|                          | (0.068)     | (0.068)      | (0.068)     |
+--------------------------+-------------+--------------+-------------+
| z_kn_total               | 0.211\*\*\* | 0.213\*\*\*  | 0.198\*\*\* |
+--------------------------+-------------+--------------+-------------+
|                          | (0.059)     | (0.059)      | (0.059)     |
+--------------------------+-------------+--------------+-------------+
| z_sdr5_tot               | 0.007       | 0.025        | 0.012       |
+--------------------------+-------------+--------------+-------------+
|                          | (0.059)     | (0.060)      | (0.059)     |
+--------------------------+-------------+--------------+-------------+
| z_frlf_rd                |             | -0.075       |             |
...
|                          |             | (0.067)      |             |
+--------------------------+-------------+--------------+-------------+
| z_frlf_tot × z_kn_total  |             |              | -0.100+     |
+--------------------------+-------------+--------------+-------------+
|                          |             |              | (0.061)     |
+--------------------------+-------------+--------------+-------------+
| SD (Intercept class_id)  | 0.112       | 0.120        | 0.122       |
+--------------------------+-------------+--------------+-------------+
| SD (Intercept school_id) | 0.101       | 0.094        | 0.084       |
+--------------------------+-------------+--------------+-------------+
| SD (Observations)        | 0.964       | 0.961        | 0.961       |
+--------------------------+-------------+--------------+-------------+
| Num.Obs.                 | 285         | 284          | 285         |
+--------------------------+-------------+--------------+-------------+
| R2 Marg.                 | 0.049       | 0.056        | 0.059       |
+--------------------------+-------------+--------------+-------------+
| R2 Cond.                 | 0.072       | 0.079        | 0.080       |
+--------------------------+-------------+--------------+-------------+
| RMSE                     | 0.95        | 0.94         | 0.94        |
+--------------------------+-------------+--------------+-------------+
| -   p \< 0.1, \* p \<    |             |              |             |
...
|                       | Base         | Facet         | Int.         |
+=======================+==============+===============+==============+
| (Intercept)           | -0.004       | -0.007        | 0.004        |
+-----------------------+--------------+---------------+--------------+
|                       | (0.056)      | (0.056)       | (0.056)      |
+-----------------------+--------------+---------------+--------------+
| z_frlf_tot            | 0.005        |               | -0.000       |
+-----------------------+--------------+---------------+--------------+
|                       | (0.066)      |               | (0.066)      |
+-----------------------+--------------+---------------+--------------+
| z_ksa3_tot            | -0.159\*     | -0.161\*      | -0.161\*     |
+-----------------------+--------------+---------------+--------------+
|                       | (0.065)      | (0.066)       | (0.065)      |
+-----------------------+--------------+---------------+--------------+
| z_kn_total            | 0.334\*\*\*  | 0.333\*\*\*   | 0.345\*\*\*  |
+-----------------------+--------------+---------------+--------------+
|                       | (0.056)      | (0.056)       | (0.057)      |
+-----------------------+--------------+---------------+--------------+
| z_sdr5_tot            | -0.082       | -0.078        | -0.085       |
+-----------------------+--------------+---------------+--------------+
|                       | (0.057)      | (0.058)       | (0.057)      |
+-----------------------+--------------+---------------+--------------+
| z_frlf_rd             |              | -0.001        |              |
...
| school_id)            |              |               |              |
+-----------------------+--------------+---------------+--------------+
| SD (Observations)     | 0.937        | 0.939         | 0.936        |
+-----------------------+--------------+---------------+--------------+
| Num.Obs.              | 285          | 284           | 285          |
+-----------------------+--------------+---------------+--------------+
| R2 Marg.              | 0.132        | 0.131         | 0.137        |
+-----------------------+--------------+---------------+--------------+
| RMSE                  | 0.93         | 0.93          | 0.93         |
+-----------------------+--------------+---------------+--------------+
| -   p \< 0.1, \* p \< |              |               |              |
...
```
  ...
  Model                            ICC    R2_m    R2_c
  ---------------------------- ------- ------- -------
  HPT total (CTX6) --- Base         NA   0.113      NA
  HPT total (CTX6) --- Facet        NA   0.116      NA
  HPT total (CTX6) --- Int.         NA   0.114      NA
  CONT --- Base                  0.024   0.049   0.072
  CONT --- Facet                 0.025   0.056   0.079
  CONT --- Int.                  0.023   0.059   0.080
  POP_rev --- Base                  NA   0.132      NA
  POP_rev --- Facet                 NA   0.131      NA
  POP_rev --- Int.                  NA   0.137      NA
...
```
  ...
  ------------- ------------- ----------------------- ---------- ---------- ----------- ---------
  HPT total     Base          z_frlf_tot                   0.012     -0.120       0.143     0.863
  (CTX6)                                                                                

  HPT total     Base          z_ksa3_tot                  -0.052     -0.183       0.079     0.435
  (CTX6)                                                                                

  HPT total     Base          z_kn_total                   0.336      0.223       0.448     0.000
  (CTX6)                                                                                

  HPT total     Base          z_sdr5_tot                  -0.043     -0.156       0.070     0.455
  (CTX6)                                                                                

  HPT total     Facet         z_frlf_rd                   -0.047     -0.178       0.083     0.474
  (CTX6)                                                                                

  HPT total     Facet         z_frlf_ns                    0.065     -0.064       0.194     0.325
  (CTX6)                                                                                

  HPT total     Facet         z_ksa3_tot                  -0.050     -0.181       0.081     0.454
  (CTX6)                                                                                

  HPT total     Facet         z_kn_total                   0.337      0.224       0.449     0.000
  (CTX6)                                                                                

  HPT total     Facet         z_sdr5_tot                  -0.029     -0.143       0.086     0.622
  (CTX6)                                                                                

  HPT total     Interaction   z_frlf_tot                   0.013     -0.119       0.145     0.851
  (CTX6)                                                                                

  HPT total     Interaction   z_kn_total                   0.333      0.219       0.447     0.000
  (CTX6)                                                                                

  HPT total     Interaction   z_ksa3_tot                  -0.052     -0.183       0.079     0.438
  (CTX6)                                                                                

  HPT total     Interaction   z_sdr5_tot                  -0.042     -0.155       0.071     0.466
  (CTX6)                                                                                

  HPT total     Interaction   z_frlf_tot:z_kn_total       -0.020     -0.137       0.096     0.732
  (CTX6)                                                                                

  CONT          Base          z_frlf_tot                   0.004     -0.131       0.140     0.949

  CONT          Base          z_ksa3_tot                   0.062     -0.073       0.196     0.367

  CONT          Base          z_kn_total                   0.211      0.096       0.327     0.000

  CONT          Base          z_sdr5_tot                   0.007     -0.109       0.123     0.904

  CONT          Facet         z_frlf_rd                   -0.075     -0.209       0.058     0.267

  CONT          Facet         z_frlf_ns                    0.083     -0.049       0.215     0.217

  CONT          Facet         z_ksa3_tot                   0.066     -0.068       0.201     0.332

  CONT          Facet         z_kn_total                   0.213      0.098       0.328     0.000

  CONT          Facet         z_sdr5_tot                   0.025     -0.092       0.143     0.674

  CONT          Interaction   z_frlf_tot                   0.010     -0.125       0.145     0.885

  CONT          Interaction   z_kn_total                   0.198      0.082       0.314     0.001

  CONT          Interaction   z_ksa3_tot                   0.064     -0.070       0.198     0.348

  CONT          Interaction   z_sdr5_tot                   0.012     -0.104       0.128     0.840

  CONT          Interaction   z_frlf_tot:z_kn_total       -0.100     -0.220       0.019     0.099

  POP_rev       Base          z_frlf_tot                   0.005     -0.125       0.134     0.945

  POP_rev       Base          z_ksa3_tot                  -0.159     -0.288      -0.031     0.016

  POP_rev       Base          z_kn_total                   0.334      0.224       0.445     0.000

  POP_rev       Base          z_sdr5_tot                  -0.082     -0.194       0.030     0.150

  POP_rev       Facet         z_frlf_rd                   -0.001     -0.131       0.128     0.984

  POP_rev       Facet         z_frlf_ns                    0.011     -0.118       0.139     0.871

  POP_rev       Facet         z_ksa3_tot                  -0.161     -0.290      -0.031     0.015

  POP_rev       Facet         z_kn_total                   0.333      0.222       0.444     0.000

  POP_rev       Facet         z_sdr5_tot                  -0.078     -0.192       0.036     0.178

  POP_rev       Interaction   z_frlf_tot                   0.000     -0.130       0.130     0.995

  POP_rev       Interaction   z_kn_total                   0.345      0.233       0.456     0.000

  POP_rev       Interaction   z_ksa3_tot                  -0.161     -0.290      -0.032     0.015

  POP_rev       Interaction   z_sdr5_tot                  -0.085     -0.197       0.026     0.134

  POP_rev       Interaction   z_frlf_tot:z_kn_total        0.074     -0.042       0.189     0.210
  -----------------------------------------------------------------------------------------------
