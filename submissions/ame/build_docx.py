"""Build AME submission DOCX from manuscript.md.
...
Usage:
    .venv/bin/python submissions/ame/build_docx.py
"""
import re
import subprocess
import sys
...
def step0_preprocess() -> tuple[Path, Path]:
    ...
    # Remove author block (lines between YAML end and Abstract heading)
    anon = re.sub(
...
if __name__ == "__main__":
    print("Building AME manuscripts...")
