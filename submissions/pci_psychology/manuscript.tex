...
This study reports a Czech adaptation of the Hartmann and
...
The evaluation protocol used here provides an evidence-based model for evaluating fairness when assessment content intersects with respondents' attitudes. Although developed for HPT, the protocol may inform studies of other scenario-based assessments where content carries attitudinal valence. The general approach involves five steps:
