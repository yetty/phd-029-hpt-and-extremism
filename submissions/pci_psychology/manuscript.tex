...
correlated with the primary six-item contextualization composite (\emph{r} = .34, 95\% CI [.23, .43]); the combined ideology score was
...
and validity evidence. \citet{Huijgen_et_al2017Toward} subsequently
...
format transfers unchanged across topics or elicits the intended process.
...
competence \citep[pp.~54--58, 140, 143]{RVPZV2023}. School curricula broadly align
...
This documentary account applies specifically to the lower-secondary
...
\citep{Barton2004,Endacott_Brooks2013An_Updated}. Under the narrower cognitive
...
The Results follow the two measurement questions in sequence. Sections
...
10.46, \emph{p}\_raw = .033), well above the Bonferroni threshold
after correction (\emph{p}\_adj = .300). GRM item discrimination and
...
Table 6 presents the stepwise MG-CFA results. The configural model produced CFI = .977, RMSEA = .044, and SRMR = .074. Adding equality constraints did not worsen global fit: metric \(\Delta\)CFI = $-$.001 and \(\Delta\)RMSEA = $-$.001; scalar \(\Delta\)CFI = +.005 and \(\Delta\)RMSEA = $-$.008. These changes fall within common fit-index criteria \citep{Chen2007,Cheung2002}. All three models converged and passed lavaan's post-estimation admissibility check; the diagonals of their model-implied residual-variance matrices were positive.
...
\emph{Note.} \(\Delta\)CFI and \(\Delta\)RMSEA computed relative to the preceding model. Invariance criteria: $|\Delta\text{CFI}|$ \(\leq\) .01, $|\Delta\text{RMSEA}|$ \(\leq\) .015 \citep{Chen2007}. Low and High ideology groups formed by tertile split on composite ideology; complete item-response data were available for 92 Low and 90 High participants. Items treated as ordered categorical.
...
evidence rather than a firm equivalence conclusion: the analysis was
...
\emph{n} = 123 (High), with 37 middle-tertile cases and 7 missing NS scores
excluded. Fit did not
deteriorate when equality constraints were added (configural CFI = .959,
RMSEA = .051, SRMR = .071;
...
contextualization composite: \(\beta\) = .016, \emph{SE} = .068, 95\%
...
Historical knowledge was the only consistent
...
coefficient for the primary composite remained non-significant
...
right-authoritarian attitudes did not predict the primary HPT composite;
fit-index changes were compatible with scalar invariance, subject to small
extreme groups and unmodelled clustering. The Czech adaptation showed modest subscale reliability, a positive relationship with scenario-relevant historical knowledge, and sensitivity to school-level variation. An unadjusted exploratory authoritarianism--reversed-presentism association was not subjected to the preregistered multiplicity procedure; other ideology and social-desirability associations were not detected, although weak reliability constrains the latter null associations.
...
equivalence conclusion. The DIF analysis
...
associations \citep{Chapman2021Introduction,Hartmann_Hasselhorn2008Historical,Wineburg2001Historical}, a near-zero primary ideology correlation, and null social desirability
...
An alternative explanation for the compatible invariance fit pattern
...
patterns across ideology groups, the resulting apparent invariance
...
\item \emph{Convenience sampling and unavailable socioeconomic data.}
  The sample over-represented upper-secondary students and was not
...
in the primary composite at the available sensitivity. Whether this pattern extends to more polarized
