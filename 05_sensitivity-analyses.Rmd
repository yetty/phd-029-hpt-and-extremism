...
dat <- dat %>%
  mutate(
    ...
    SDR_total  = scale_mean(., paste0("SDR", 1:5), 4),
    NS_sum     = scale_mean(., paste0("NS", 1:3), 2),
    RD_sum     = scale_mean(., paste0("RD", 1:3), 2),
    FRLF_mini  = scale_mean(., c(paste0("NS", 1:3),
                                 paste0("RD", 1:3)), 4),
    KSA_A      = scale_mean(., paste0("A", 1:3), 2),
    KSA_U      = scale_mean(., paste0("U", 1:3), 2),
    KSA_K      = scale_mean(., paste0("K", 1:3), 2),
